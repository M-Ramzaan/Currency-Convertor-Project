...
async function welcome() {
    let rainbowTitle = chalkAnimation.rainbow(`Welcome to "Razmi's Currency Convertor`);
    await sleep();
    rainbowTitle.stop();
...
if (userRes.Current === userRes.Required) {
    console.log(chalk.bgRed(`Sorry! You select the same currency for conversion. Please select a different current and required currency.`));
}
else {
